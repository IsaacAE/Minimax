...
public class Juego {
   ...
   * @return boolean
   */
  public boolean moverFichaCuadrante(
    int cuandrante,
    Jugador jugador,
    Ficha ficha
  ) {
  ...
  public void repararTablero() {
    ...
    this.asignarFicha(
        jugador.ficha1.getFila(),
        jugador.ficha1.getColumna(),
        jugador,
        1
      );
    this.asignarFicha(
        jugador.ficha2.getFila(),
        jugador.ficha2.getColumna(),
        jugador,
        2
      );
