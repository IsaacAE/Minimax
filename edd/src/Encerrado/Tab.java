 ...
 */
    ...
    public void pintarTablero(){
        ...
        System.out.println("["+this.tablero[0][0]+blanco+"] -----["+blanco+this.tablero[0][2]+blanco+"]");
        System.out.println(blanco+" | "+linea+"    /  |"+blanco);
        System.out.println(" |   ["+blanco+this.tablero[1][1]+blanco+"]   |");
        System.out.println(blanco+" | /    "+linea+"  |"+blanco);
        System.out.println("["+blanco+this.tablero[2][0]+blanco+"]      ["+blanco+this.tablero[2][2]+blanco+"]");
    }
    ...
    public void cambiarFichas(int indice1, int indice2, int indice3 , int indice4) {
       ...
       * @return boolean
       */
public boolean validarMov(int filaInicial, int columInicial, int filaFinal, int columFinal){
    //SI se quiere mover de entre las esquinas inferiores (de izquierda a derecha o viceversa) devuelve falso
    if(filaInicial==2&&filaFinal==2&&Math.abs(columFinal-columInicial)==2){
        return false;
    }
